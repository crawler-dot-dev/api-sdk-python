...
class ExtractResource(SyncAPIResource):
    ...
    def with_raw_response(self) -> ExtractResourceWithRawResponse:
        ...
        For more information, see https://www.github.com/stainless-sdks/api.crawler.dev-sdks-python#accessing-raw-response-data-eg-headers
        """
    ...
    def with_streaming_response(self) -> ExtractResourceWithStreamingResponse:
        ...
        For more information, see https://www.github.com/stainless-sdks/api.crawler.dev-sdks-python#with_streaming_response
        """
